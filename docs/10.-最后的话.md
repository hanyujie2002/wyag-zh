...
此页面没有评论系统 :) 可以通过电子邮件联系我，邮箱是 <thibault@thb.lt>。也可以在 [Mastodon 上找到我，用户名是 @thblt@toad.social](https://toad.social/@thblt)，在 [Twitter 上是 @ThbPlg](https://twitter.com/ThbPlg)，偶尔在 Libera 的 IRC 上以 `thblt` 身份出现。
